...
const VO: Record<VoLang, VoSet> = {
  ...
  de: { files: ["/assets/about/vo-de-1.mp3", "/assets/about/vo-de-2.mp3", "/assets/about/vo-de-3.mp3"], durs: [398.81, 388.52, 299.86] },
...
const CUES: Record<VoLang, number[]> = {
  ...
  de: [0, 18.53, 72.35, 124.48, 184.13, 227.36, 271.99, 393.67, 414.27, 464.16, 498.52, 617.55, 684.04, 734.82, 777.49, 821.72, 858.1, 890.39, 951.5, 993.87, 1074.09],
